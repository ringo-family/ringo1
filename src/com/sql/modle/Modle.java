package com.sql.modle;

import java.util.Date;
//定义数据模型类用来储存从数据库获得的数据
public class Modle {
	private Integer id;
	...
	public String toString() {
		return "Modle [id=" + id + ", user_name=" + user_name + ", sex=" + sex
				+ ", age=" + age + ", birthday=" + birthday + ", email="
				+ email + ", mobile=" + mobile + ", creater_user="
				+ creater_user + ", creater_date=" + creater_date
				+ ", update_user=" + update_user + ", update_date="
